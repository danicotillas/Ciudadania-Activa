...
;
			...
			$headers[] = 'Sender: Sistema de emisión de badge de Ciudadanía Activa <info@martadero.org>' . "\r\n";
...
"\r\n" .
'2. Visita el panel de administración de Ciudadanía Activa: puedes aprobar la solicitud pinchando sobre el botón azul "Publicar" que verás una vez hayas accedido al panel: http://ciudadaniaactiva.martadero.org/wp-admin/post.php?post=' .$earner_id. '&action=edit'.
"\r\n\r\n" .
'Si crees que el usuario no cumple alguno de los requisitos quizás quieras ponerte en contacto con él: ' .$earner_mail.
"\r\n\r\n" .
'Puedes escribirnos a Ciudadanía Activa respondiendo a este correo sobre cualquier duda que tengas sobre el sistema de emisión.'.
"\r\n\r\n" .
'Un saludo del equipo de Ciudadanía Activa.'
;
	$headers[] = 'From: Sistema de emisión de badge de Ciudadanía Activa <info@martadero.org>' . "\r\n";
	$headers[] = 'Reply-To: Sistema de emisión de badge de Ciudadanía Activa <info@martadero.org>' . "\r\n";
	$headers[] = 'To: <' .$to. '>' . "\r\n";
	// To send HTML mail, the Content-type header must be set, uncomment the following two lines
	//$headers[]  = 'MIME-Version: 1.0' . "\r\n";
	//$headers[] = 'Content-type: text/html; charset=utf-8' . "\r\n";
...
function quincem_contact_issuer($post) {
	...
	$headers[] = 'Sender: Formulario de contacto de Ciudadanía Activa <no-reply@martadero.org>' . "\r\n";
	$headers[] = 'Reply-To:  '.$sender_name. ' <' .$sender_mail. '>' . "\r\n";
	$headers[] = 'To: ' .$issuer_name. ' <' .$to. '>' . "\r\n";
	$subject = "Mensaje desde el formulario de contacto de Ciudadanía Activa";
	$message = 
'Hola ' .$issuer_name.','
. "\r\n\r\n" .
'el usuario '.$sender_name.' te ha enviado el siguiente mensaje desde el formulario de contacto de tu perfil en Ciudadanía Activa ('.$perma.'):'
. "\r\n\r\n" .
$sender_message
. "\r\n\r\n" .
...
'Un saludo,'
. "\r\n" .
'El sistema autómatico de mensajería de Ciudadanía Activa'
;
	wp_mail( $to, $subject, $message, $headers);
	...
	if ( sanitize_text_field( $_POST['quincem-form-contact-copy'] ) == true ) {
		$to = $sender_mail;
		$headers[] = 'From: Formulario de contacto de Ciudadanía Activa <no-reply@martadero.org>' . "\r\n";
		$headers[] = 'Sender: Formulario de contacto de Ciudadanía Activa <no-reply@martadero.org>' . "\r\n";
